...
# Must fit on 1 page, filled at 79 characters.
gettext "Voilà, cette image est une image au format PNG.

On peut l'éditer avec The Gimp (commande gimp), la visualiser avec Eye of Gnome
(commande eog), par exemple.

Pour les curieux, vous remarquerez que l'image ressemble à ce que produit
l'utilitaire a2ps. Ce n'est pas une coincidence, il a été généré avec a2ps et
